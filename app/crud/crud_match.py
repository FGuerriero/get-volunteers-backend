...
def get_matches_for_volunteer(db: Session, volunteer_id: int):
    ...
    """
    return db.query(models.VolunteerNeedMatch).filter(models.VolunteerNeedMatch.volunteer_id == volunteer_id).all()
...
def delete_matches_for_volunteer(db: Session, volunteer_id: int):
    ...
    """
    db.query(models.VolunteerNeedMatch).filter(models.VolunteerNeedMatch.volunteer_id == volunteer_id).delete()
    db.commit()
    return True
